...
from inserir_produto import listar_produtos, excluir_produto
...
def exibir_produtos():
    ...
    if not produtos:
        messagebox.showinfo("produto", "Nenhum usuário cadastrado.")
        return
    ...
    def excluir():
        ...
        if confirmar:
            excluir_produto(nome)  # função no banco de dados
